...
namespace DVLDtraining.Drivers.Controls
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        private void cmsLocalLicenseHistory_Opening(object sender, System.ComponentModel.CancelEventArgs e)
        {
            if ((int)dgvLocalLicensesHistory.Rows.Count == 0)
                showLicenseInfoToolStripMenuItem.Enabled = false;
        }

        private void cmsInterenationalLicenseHistory_Opening(object sender, System.ComponentModel.CancelEventArgs e)
        {
            if ((int)dgvInternationalLicensesHistory.Rows.Count == 0)
        ...
        {
            Licenses.Forms.frmShowLicenseInfo frm = new Licenses.Forms.frmShowLicenseInfo((int)dgvLocalLicensesHistory.CurrentRow.Cells[0].Value);
        ...
        {
            Licenses.Forms.frmShowInternationalLicenseInfo frm = new frmShowInternationalLicenseInfo((int)dgvInternationalLicensesHistory.CurrentRow.Cells[0].Value);
